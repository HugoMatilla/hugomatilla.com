...
<!-- /TOC -->
# 1. Introduction 
This is a continuation of the Article [Android Design System and Theming: Typography](https://github.com/HugoMatilla/Android-Design-System-and-Theming-Typography#android-design-system-and-theming-typography). In that article I explained why having a Style System help us to have a cohesive and easy to develop UI in our apps.
...
> You can learn about theme attributes in my previous post in the section [Theme attributes in less than 100 words.](https://github.com/HugoMatilla/Android-Design-System-and-Theming-Typography/blob/master/readme.md#theme-attributes-vs-view-attributes-in-less-than-100-words)
...
## 8.2. Dark Theme
Dark Theme is a big topic that will be fit best in a different post. But to give it a try in your app you can do these simple steps:
